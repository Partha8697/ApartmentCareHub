                    ...
                    <div class="container-fluid px-4">
                        <div class="card mt-4 shadow-sm">
                            <div class="card-header">
                                <h4 class="mb-0 dash-heading">Change Password
                                    <a href="admin-profile.php" class="btn btn-danger float-end">Back</a>
                                </h4>
                            </div>
                            <div class="card-body">
                                <form class="row g-3 p-3" method="post">
                                    <?php
                                        ...
                                        $query = "SELECT * FROM `admin` WHERE id = '$adminID' LIMIT 1";
                                    ...
                                    <div class="col-12">
                                        ...
                                        <span class="error"><?php echo implode(" ",$opErr);?></span>
                                    </div>
                                    <div class="col-12">
                                        <label for="" class="form-label">New Password</label>
                                        <input type="password" class="form-control" name="np" placeholder="New Password">
                                        <span class="error"><?php echo implode(" ",$npErr);?></span>
                                    </div>
                                    <div class="col-12">
                                        <label for="" class="form-label">Repeat Password</label>
                                        <input type="password" class="form-control" name="rp" placeholder="Repeat Password">
                                        <span class="error"><?php echo implode(" ",$rpErr);?></span>
                                    </div>
