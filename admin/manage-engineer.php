                ...
                <main class="custom-main">
                    <div class="custom-flex-container">
                        <div class="dash-container">
                            <h1 class="dash-heading">Engineer List</h1>
                        </div>
                    </div>
                    <div class="container-fluid px-4">
                        <div class="card mt-4 shadow-sm">
                            <div class="card-header">
                                <h4 class="mb-0">
                                    <a href="add-engineer.php" class="btn btn-primary float-end">Add Engineer</a>
                                </h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="engineer-edit.php?id=<?= $row['id']; ?>" class="btn btn-primary">EDIT</a>
                                                        <a href="engineer-delete.php?id=<?= $row['id']; ?>" class="btn btn-danger">REMOVE</a>
                                                    </td>
                                                </tr>
                                                <?php
                                                    }
