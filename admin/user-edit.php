                    ...
                    <div class="container-fluid px-4">
                        <div class="card mt-4 shadow-sm">
                            <div class="card-header">
                                <h4 class="mb-0">
                                    <a href="manage-admin.php" class="btn btn-danger float-end">Back</a>
                                </h4>
                            </div>
                            <div class="card-body">
                                <form class="row g-3" method="post">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" name="name" value="<?php echo $UserName; ?>" placeholder="Full Name">
                                        <span class="error"><?php echo implode(" ",$nameErr);?></span>
                                    </div>
                                    <div class="col-12">
                                        <label for="inputemail" class="form-label">Email</label>
                                        <input type="email" class="form-control" name="email" value="<?php echo $UserEmail; ?>" placeholder="Email" disabled>
                                    </div>
                                    <div class="col-12">
                                        <label for="inputpassword" class="form-label">Password</label>
                                        <input type="text" class="form-control" name="password" value="<?php echo $UserPass; ?>" placeholder="Password">
