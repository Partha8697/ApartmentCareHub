    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a class="active" href="manage-admin.php">
                ...
                <main class="custom-main">
                    <div class="custom-flex-container">
                        <div class="dash-container">
                            <h1 class="dash-heading">Admin List</h1>
                        </div>
                    </div>
                        ...
                        <div class="card mt-4 shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    ?>
                                    <table class="table table-hover table-bordered text-center" id="d" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th scope="col">Id</th>
                                        ...
                                        <tbody>
                                            <?php 
                                                while($row=mysqli_fetch_assoc($result)) {
                                                    ...
                                                    if($adminEmail != $fetch_info['email']) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="admin-edit.php?id=<?= $row['id']; ?>" class="btn btn-primary">EDIT</a>
                                                    <a href="admin-delete.php?id=<?= $row['id']; ?>" class="btn btn-danger">REMOVE</a>
                                                </td>
                                            </tr>
                                            <?php
                                                }
