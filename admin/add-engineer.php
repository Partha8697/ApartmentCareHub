                ...
                <main class="custom-main">
                    <div class="custom-flex-container">
                        <div class="dash-container">
                            <h1 class="dash-heading">Add Engineer</h1>
                        </div>
                    </div>
                    <div class="container-fluid px-4">
                        <div class="card mt-4 shadow-sm">
                            <div class="card-header">
                                <h4 class="mb-0">
                                    <a href="manage-engineer.php" class="btn btn-danger float-end">Go Back</a>
                                </h4>
                            </div>
                            <div class="card-body">
                                <form class="row g-3" method="post">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" name="role" placeholder="Role of the Engineer">
