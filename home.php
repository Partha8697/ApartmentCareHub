                ...
                <main class="custom-main">
                    <div class="custom-flex-container">
                        <div class="dash-container">
                            <h1 class="dash-heading">Welcome, <?php echo $fetch_info['name'] ?></h1>
                        ...
                        <div class="custom-container">
                            ...
                            <div class="custom-text">
                                <span class="custom-number">
                                    <?php
                                        try {
                                            $cmp = mysqli_query($con, "SELECT * FROM complaint where email = '$email' and status = 'pending'");
                        ...
                        <div class="custom-container">
                            ...
                            <div class="custom-text">
                                <span class="custom-number">
                                    <?php
                                        try {
                                            $cmp = mysqli_query($con, "SELECT * FROM complaint where email = '$email' and status = 'inprogress'");
                                            $count_cmp = mysqli_num_rows($cmp);
                                            echo $count_cmp;
                                        } catch (\Throwable $th) {
                                            echo $th;
                        ...
                        <div class="custom-container">
                            ...
                            <div class="custom-text">
                                <span class="custom-number">
                                    <?php
                                        try {
                                            $cmp = mysqli_query($con, "SELECT * FROM complaint where email = '$email' and status = 'completed'");
                                            $count_cmp = mysqli_num_rows($cmp);
                                            echo $count_cmp;
                                        } catch (\Throwable $th) {
                                            echo $th;
