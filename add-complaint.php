...
require_once "process-complaint.php"; ?>
<?php 
$email = $_SESSION['email'];
$password = $_SESSION['password'];
$ref = rand (9999999,100000);
                ...
                <div class="wrapper">
                    ...
                    <form action="add-complaint.php" method="post" novalidate>
                        ...
                        <div class="inputfield">
                            ...
                            <input type="number" name="refno" class="input input-style" value="<?php echo $ref; ?>" readonly>
                        </div>  
                        <div class="inputfield">
                            <label>Full Name</label>
                            <input type="text" name="name" class="input input-style" value="<?php echo $fetch_info['name'] ?> "readonly>
                        </div>  
                        <div class="inputfield">
                            <label>Email</label>
                            <input type="email" name="email" class="input input-style" value="<?php echo $fetch_info['email'] ?>" readonly>
                        </div>  
                        <div class="inputfield">
                            <label>Contact No.</label>
                            <input type="text" name="contact" class="input" value="<?php echo $fetch_info['contact'] ?>" placeholder="Your Phone Number">
                        </div> 
                        <div class="inputfield">
                            <label>Apartment No.</label>
                            <input type="text" name="apartment" class="input" value="<?php echo $fetch_info['apartmentno'] ?>" placeholder="Your Apartment Number">
                        </div> 
                        <div class="inputfield">
