    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a class="active" href="complaint-history.php">
                ...
                <main class="custom-main">
                    <div class="custom-flex-container">
                        <div class="dash-container">
                            <h1 class="dash-heading">Complaint History</h1>
                        </div>
                    </div>
                        ...
                        <div class="card mt-4 shadow-sm">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <?php
                                    $query = "SELECT * FROM `view_cmp` WHERE email = '$fetch_info[email]' AND status = 'completed'";
