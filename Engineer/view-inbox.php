                ...
                <main class="custom-main">
                    ...
                    <div class="container">
                        <form>
                            ...
                            <input type="hidden" readonly class="form-control-plaintext" value="<?php echo $ID; ?>">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" readonly class="form-control-plaintext" value="pending">
                                </div>
                            </div>
                            <a href="process-complaint.php?id=<?= $ID; ?>" class="btn btn-danger">TAKE ACTION</a>
