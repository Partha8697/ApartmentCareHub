                ...
                <main class="custom-main">
                    <div class="custom-flex-container">
                        <div class="dash-container">
                            <h1 class="dash-heading">Inbox</h1>
                        </div>
                    </div>
                        ...
                        <div class="card mt-4 shadow-sm">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <?php
                                       $query = "SELECT * FROM `view_cmp` WHERE status='inprogress'";
                                    ...
                                    <table class="table table-striped table-hover table-bordered border-secondary text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($Status == 'inprogress') { echo 'pending'; } ?></td>
                                                <td>
                                                    <a href="view-inbox.php?id=<?= $row['cmp_id']; ?>" class="btn btn-outline-primary">VIEW</a>
